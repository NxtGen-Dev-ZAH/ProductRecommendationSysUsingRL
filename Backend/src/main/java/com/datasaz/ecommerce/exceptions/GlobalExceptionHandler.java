...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleBadRequestException(BadRequestException ex, HttpServletRequest request) {
        ...
        return buildResponse(ExceptionMessages.BAD_REQUEST + ex.getMessage(), HttpStatus.BAD_REQUEST, "BadRequest", request);
    }
...
public class GlobalExceptionHandler {
    ...
    // Special handling for CategoryNotFoundException to match test expectations
    @ExceptionHandler(CategoryNotFoundException.class)
    public ResponseEntity<String> handleCategoryNotFoundException(CategoryNotFoundException ex, HttpServletRequest request) {
        log.warn("Category not found: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ExceptionMessages.CATEGORY_NOT_FOUND + "Category not found.");
    }

    @ExceptionHandler(UserAlreadyExistsException.class)
    public ResponseEntity<Object> handleUserAlreadyExistsException(UserAlreadyExistsException ex, HttpServletRequest request) {
        log.warn("User already exists: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.CONFLICT, "UserAlreadyExists", request);
    }
    ...
    public ResponseEntity<Object> handleAuthenticationException(AuthenticationException ex, HttpServletRequest request) {
        log.warn("Authentication failed: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.UNAUTHORIZED, "AuthenticationError", request);
    }

    @ExceptionHandler(UnauthorizedException.class)
    public ResponseEntity<Object> handleUnauthorizedException(UnauthorizedException ex, HttpServletRequest request) {
        log.warn("Unauthorized access: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.UNAUTHORIZED, "Unauthorized", request);
    }

    @ExceptionHandler(AccessDeniedException.class)
    public ResponseEntity<Object> handleAccessDeniedException(AccessDeniedException ex, HttpServletRequest request) {
        log.warn("Access denied: {}", ex.getMessage());
        return buildResponse("Access denied: Insufficient permissions.", HttpStatus.FORBIDDEN, "AccessDenied", request);
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<Object> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex, HttpServletRequest request) {
        log.warn("Invalid request body: {}", ex.getMessage());
        return buildResponse("Invalid request body format.", HttpStatus.BAD_REQUEST, "InvalidRequestBody", request);
    }
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        Map<String, String> errors = ex.getBindingResult().getFieldErrors().stream()
                .collect(Collectors.toMap(
                        ...
                        error -> error.getDefaultMessage() != null ? error.getDefaultMessage() : "Invalid value",
                        (existing, replacement) -> existing));
        return buildResponse("Validation failed for request.", HttpStatus.BAD_REQUEST, "ValidationError", request, errors);
    }
    ...
    public ResponseEntity<Object> handleConstraintViolationException(ConstraintViolationException ex, HttpServletRequest request) {
        ...
        Map<String, String> errors = ex.getConstraintViolations().stream()
                .collect(Collectors.toMap(
                        ...
                        violation -> violation.getMessage(),
                        (existing, replacement) -> existing));
        return buildResponse("Validation failed for request parameters.", HttpStatus.BAD_REQUEST, "ConstraintViolation", request, errors);
    }

    @ExceptionHandler(CartItemNotFoundException.class)
    public ResponseEntity<Object> handleCartItemNotFoundException(CartItemNotFoundException ex, HttpServletRequest request) {
        log.warn("Cart item not found: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "CartItemNotFound", request);
    }

    @ExceptionHandler(CartNotFoundException.class)
    public ResponseEntity<Object> handleCartNotFoundException(CartNotFoundException ex, HttpServletRequest request) {
        log.warn("Cart not found: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "CartNotFound", request);
    }

    @ExceptionHandler(ProductNotFoundException.class)
    public ResponseEntity<Object> handleProductNotFoundException(ProductNotFoundException ex, HttpServletRequest request) {
        log.warn("Product not found: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "ProductNotFound", request);
    }

    @ExceptionHandler(InsufficientStockException.class)
    public ResponseEntity<Object> handleInsufficientStockException(InsufficientStockException ex, HttpServletRequest request) {
        log.warn("Insufficient stock: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "InsufficientStock", request);
    }

    @ExceptionHandler(CouponInvalidException.class)
    public ResponseEntity<Object> handleCouponInvalidException(CouponInvalidException ex, HttpServletRequest request) {
        log.warn("Invalid coupon: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "CouponInvalid", request);
    }

    @ExceptionHandler(CouponExpiredException.class)
    public ResponseEntity<Object> handleCouponExpiredException(CouponExpiredException ex, HttpServletRequest request) {
        log.warn("Coupon expired: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "CouponExpired", request);
    }

    @ExceptionHandler(CouponLimitExceededException.class)
    public ResponseEntity<Object> handleCouponLimitExceededException(CouponLimitExceededException ex, HttpServletRequest request) {
        log.warn("Coupon limit exceeded: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "CouponLimitExceeded", request);
    }
    ...
    public ResponseEntity<Object> handleBadRequestException(BadRequestException ex, HttpServletRequest request) {
        log.warn("Bad request: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "BadRequest", request);
    }

    @ExceptionHandler(ContentTooLargeException.class)
    public ResponseEntity<Object> handleContentTooLargeException(ContentTooLargeException ex, HttpServletRequest request) {
        log.warn("Payload too large: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.PAYLOAD_TOO_LARGE, "PayloadTooLarge", request);
    }

    @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex, HttpServletRequest request) {
        log.warn("Resource not found: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "ResourceNotFound", request);
    }

    @ExceptionHandler(TechnicalException.class)
    public ResponseEntity<Object> handleTechnicalException(TechnicalException ex, HttpServletRequest request) {
        log.error("Technical error: {}", ex.getMessage(), ex);
        return buildResponse("An internal server error occurred.", HttpStatus.INTERNAL_SERVER_ERROR, "TechnicalError", request);
    }

    @ExceptionHandler(IllegalParameterException.class)
    public ResponseEntity<Object> handleIllegalParameterException(IllegalParameterException ex, HttpServletRequest request) {
        log.warn("Illegal parameter: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "IllegalParameter", request);
    }

    @ExceptionHandler(UserNotFoundException.class)
    public ResponseEntity<Object> handleUserNotFoundException(UserNotFoundException ex, HttpServletRequest request) {
        log.warn("User not found: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "UserNotFound", request);
    }
    ...
    public ResponseEntity<Object> handleIllegalStateException(IllegalStateException ex, HttpServletRequest request) {
        log.warn("Illegal state: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.CONFLICT, "IllegalState", request);
    }

    @ExceptionHandler(InvalidRoleException.class)
    public ResponseEntity<Object> handleInvalidRoleException(InvalidRoleException ex, HttpServletRequest request) {
        return buildResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, "Bad Request", request);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<Object> handleGenericException(Exception ex, HttpServletRequest request) {
        log.error("Unexpected error: {}", ex.getMessage(), ex);
        return buildResponse("An unexpected error occurred.", HttpStatus.INTERNAL_SERVER_ERROR, "UnexpectedError", request);
    }
}
*/
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> nullPointerException(RuntimeException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
    ...
    @ExceptionHandler(CouponInvalidException.class)
    public ResponseEntity<ExceptionResponse> handleCouponInvalidException(CouponInvalidException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
                .status(HttpStatus.BAD_REQUEST.value())
                .error(ex.toString())
    ...
    @ExceptionHandler(CouponExpiredException.class)
    public ResponseEntity<ExceptionResponse> handleCouponExpiredException(CouponExpiredException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
                .status(HttpStatus.BAD_REQUEST.value())
                .error(ex.toString())
    ...
    @ExceptionHandler(CouponLimitExceededException.class)
    public ResponseEntity<ExceptionResponse> handleCouponLimitExceededException(CouponLimitExceededException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
                .status(HttpStatus.BAD_REQUEST.value())
                .error(ex.toString())
    ...
    public ResponseEntity<ExceptionResponse> handleOptimisticLockException(OptimisticLockException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message("Concurrent update conflict, please try again! " + ex.getMessage())
                .status(HttpStatus.CONFLICT.value())
                .error(ex.toString())
                .path(ex.getLocalizedMessage())
                .timestamp(System.currentTimeMillis())
    ...
    @ExceptionHandler(PessimisticLockException.class)
    public ResponseEntity<ExceptionResponse> handlePessimisticLockException(PessimisticLockException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message("Unable to process request due to high demand, please try again later! " + ex.getMessage())
    ...
    @ExceptionHandler(ContentTooLargeException.class)
    public ResponseEntity<ExceptionResponse> handleContentTooLargeException(ContentTooLargeException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
    ...
    @ExceptionHandler(TechnicalException.class)
    public ResponseEntity<ExceptionResponse> handleTechnicalException(TechnicalException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
                .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .error(ex.toString())
    ...
    @ExceptionHandler(IllegalParameterException.class)
    public ResponseEntity<ExceptionResponse> handleIllegalParameterException(IllegalArgumentException ex) {
        ExceptionResponse exceptionResponse = ExceptionResponse.builder()
                .message(ex.getMessage())
                .status(HttpStatus.BAD_REQUEST.value())
                .error(ex.toString())
