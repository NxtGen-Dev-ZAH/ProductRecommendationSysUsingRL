  ...
  return (
    <section className="container mx-auto px-4 py-16 bg-gray-50 rounded-3xl">
      <div className="flex justify-between items-center mb-10">
        ...
        >
          <span className="text-[#3b82f6]">Produits</span> Vedettes
        </motion.h2>
        <Link
          href="/product"
      ...
      {loading ? (
        ...
        <div className="relative">
          {/* Decorative elements */}
          <div className="hidden md:block absolute -top-6 right-[10%] w-24 h-24 bg-yellow-100 rounded-full opacity-70 blur-xl"></div>
          <div className="hidden md:block absolute -bottom-6 left-[10%] w-32 h-32 bg-blue-100 rounded-full opacity-70 blur-xl"></div>
